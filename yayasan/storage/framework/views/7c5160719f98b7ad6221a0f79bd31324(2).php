<html lang="en">
 <head>
  ...
  <title>
   Yayasan Cahaya Ayu Kota Pontianak
  </title>
 ...
 <body class="bg-black text-white">
  ...
  <nav>
    <ul class="flex space-x-4">
     <li>
      <a class="hover:text-gray-400" href="<?php echo e(route('home')); ?>">
       Home
      </a>
     </li>
     <li>
  ...
  <main class="relative">
   <img alt="A woman in a green polka dot apron cleaning a table in a cozy kitchen" class="w-full h-screen object-cover opacity-50" height="1080" src="<?php echo e(asset('yayasan/UntitledDiagram.png')); ?>" width="1920"/>
   <div class="absolute inset-0 flex flex-col items-center justify-center text-center px-4">
    ...
    <div class="flex space-x-9 mt-9">
     <a class="text-white text-2xl" href="https://www.instagram.com/lpks_cahayaayu?utm_source=ig_web_button_share_sheet&igsh=ZDNlZDc0MzIxNw==">
...
<?php /**PATH C:\xampp\htdocs\yayasan\resources\views/home.blade.php ENDPATH**/ ?>