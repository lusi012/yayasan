<html lang="en">
 ...
 <body class="bg-black text-white">
  ...
  <main class="relative">
   <img alt="A woman in a green polka dot apron cleaning a table in a cozy kitchen" class="w-full h-screen object-cover opacity-50" height="1080" src="{{asset('yayasan/UntitledDiagram.png')}}" width="1920"/>
